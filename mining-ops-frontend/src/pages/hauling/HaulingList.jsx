    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Monitor and manage hauling operations in real-time</p>
        </div>
        ...
        <div className="card bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-purple-600">{allActivities.filter((a) => ['LOADING', 'HAULING', 'DUMPING', 'RETURNING'].includes(a.status)).length}</p>
            </div>
        ...
        <div className="card bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{allActivities.filter((a) => a.status === 'COMPLETED').length}</p>
            </div>
        ...
        <div className="card bg-gradient-to-br from-red-50 to-rose-50 border-red-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-600">{allActivities.filter((a) => a.isDelayed || a.status === 'DELAYED').length}</p>
            </div>
        ...
        <div className="card bg-gradient-to-br from-gray-50 to-slate-50 border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-600">{allActivities.filter((a) => a.status === 'CANCELLED').length}</p>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex-1 flex items-center space-x-3">
              ...
              <select value={shiftFilter} onChange={(e) => setShiftFilter(e.target.value)} className="input-field min-w-[150px]">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div>
                  ...
                  <select value={filters.truckId} onChange={(e) => setFilters({ ...filters, truckId: e.target.value })} className="input-field">
                ...
                <div>
                  ...
                  <select value={filters.excavatorId} onChange={(e) => setFilters({ ...filters, excavatorId: e.target.value })} className="input-field">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Min Weight (ton)</label>
                  <input type="number" value={filters.minWeight} onChange={(e) => setFilters({ ...filters, minWeight: e.target.value })} placeholder="0" className="input-field" step="0.1" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Max Weight (ton)</label>
                  <input type="number" value={filters.maxWeight} onChange={(e) => setFilters({ ...filters, maxWeight: e.target.value })} placeholder="100" className="input-field" step="0.1" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Min Distance (km)</label>
                  <input type="number" value={filters.minDistance} onChange={(e) => setFilters({ ...filters, minDistance: e.target.value })} placeholder="0" className="input-field" step="0.1" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Max Distance (km)</label>
                  <input type="number" value={filters.maxDistance} onChange={(e) => setFilters({ ...filters, maxDistance: e.target.value })} placeholder="10" className="input-field" step="0.1" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Delay Status</label>
                  <select value={filters.isDelayed} onChange={(e) => setFilters({ ...filters, isDelayed: e.target.value })} className="input-field">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
              <tr>
                <th className="table-header cursor-pointer hover:bg-gray-200 transition-colors group" onClick={() => handleSort('activityNumber')}>
                  <div className="flex items-center justify-between">
                    <span>Activity No.</span>
                    {sortField === 'activityNumber' && (sortOrder === 'asc' ? <SortAsc size={16} className="text-blue-600" /> : <SortDesc size={16} className="text-blue-600" />)}
                  </div>
                </th>
                <th className="table-header">Truck</th>
                <th className="table-header">Excavator</th>
                <th className="table-header">Operator</th>
                <th className="table-header cursor-pointer hover:bg-gray-200 transition-colors group" onClick={() => handleSort('loadWeight')}>
                  <div className="flex items-center justify-between">
                    <span>Load (ton)</span>
                    {sortField === 'loadWeight' && (sortOrder === 'asc' ? <SortAsc size={16} className="text-blue-600" /> : <SortDesc size={16} className="text-blue-600" />)}
                  </div>
                </th>
                <th className="table-header cursor-pointer hover:bg-gray-200 transition-colors group" onClick={() => handleSort('distance')}>
                  <div className="flex items-center justify-between">
                    <span>Distance (km)</span>
                    {sortField === 'distance' && (sortOrder === 'asc' ? <SortAsc size={16} className="text-blue-600" /> : <SortDesc size={16} className="text-blue-600" />)}
                  </div>
                </th>
                ...
                <tr>
                  <td colSpan="9" className="text-center py-12">
                    <div className="flex flex-col items-center space-y-3">
                      ...
                      <p className="text-gray-500 font-medium">No hauling activities found</p>
                ...
                activities.map((activity) => (
                  <tr key={activity.id} className="hover:bg-blue-50 transition-colors">
                    <td className="table-cell">
                      <span className="font-bold text-blue-600">{activity.activityNumber}</span>
                      {activity.isDelayed && <span className="ml-2 text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full">Delayed</span>}
                    </td>
                    <td className="table-cell">
                      <span className="font-medium text-gray-900">{activity.truck?.code || '-'}</span>
                      <p className="text-xs text-gray-500">{activity.truck?.name || ''}</p>
                    </td>
                    <td className="table-cell">
                      <span className="font-medium text-gray-900">{activity.excavator?.code || '-'}</span>
                      <p className="text-xs text-gray-500">{activity.excavator?.name || ''}</p>
                    </td>
                    <td className="table-cell">
                      <span className="text-gray-900">{activity.operator?.user?.fullName || '-'}</span>
                      <p className="text-xs text-gray-500">{activity.operator?.employeeNumber || ''}</p>
                    </td>
                    <td className="table-cell">
                      <span className="font-semibold text-gray-900">{activity.loadWeight}</span>
                      <p className="text-xs text-gray-500">Target: {activity.targetWeight}</p>
                      {activity.loadEfficiency && <p className="text-xs text-green-600">{activity.loadEfficiency.toFixed(1)}%</p>}
                    </td>
                    <td className="table-cell">
                      <span className="font-semibold text-gray-900">{activity.distance}</span>
                    </td>
                    <td className="table-cell text-gray-700">{activity.shift?.replace('SHIFT_', 'Shift ')}</td>
                    <td className="table-cell">
        ...
        title={
          modalMode === 'create' ? (
            ...
            <div className="flex items-center space-x-3">
              ...
              <span>Edit Hauling Activity</span>
            </div>
          ) : (
            <div className="flex items-center space-x-3">
              ...
              <span>Hauling Activity Details</span>
            </div>
          )
        }
        size="2xl"
        ...
        {modalMode === 'view' && selectedActivity ? (
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">{selectedActivity.activityNumber}</h3>
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                <div className="bg-white p-3 rounded-lg border border-blue-100">
                  ...
                  <p className="text-lg font-medium text-gray-900">{selectedActivity.shift?.replace('SHIFT_', 'Shift ')}</p>
                </div>
                <div className="bg-white p-3 rounded-lg border border-blue-100">
                  <div className="flex items-center space-x-2 mb-1">
                    <Calendar className="text-blue-600" size={16} />
                    <label className="text-xs font-semibold text-gray-600">Loading Time</label>
                  </div>
                  <p className="text-sm font-medium text-gray-900">{selectedActivity.loadingStartTime ? new Date(selectedActivity.loadingStartTime).toLocaleString() : '-'}</p>
                </div>
                <div className="bg-white p-3 rounded-lg border border-blue-100">
                  <div className="flex items-center space-x-2 mb-1">
                    <MapPin className="text-blue-600" size={16} />
                    <label className="text-xs font-semibold text-gray-600">Road Condition</label>
                  </div>
                  <p className="text-lg font-medium text-gray-900">{selectedActivity.roadCondition || 'GOOD'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-lg font-medium text-gray-900">{selectedActivity.truck?.code || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.truck?.name || ''}</p>
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-2">
                  <Construction className="text-orange-600" size={18} />
                  <label className="text-sm font-semibold text-gray-600">Excavator</label>
                </div>
                <p className="text-lg font-medium text-gray-900">{selectedActivity.excavator?.code || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.excavator?.name || ''}</p>
                <p className="text-xs text-gray-500">
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-lg font-medium text-gray-900">{selectedActivity.operator?.user?.fullName || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.operator?.employeeNumber || ''}</p>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-lg font-medium text-gray-900">{selectedActivity.supervisor?.fullName || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.supervisor?.username || ''}</p>
              </div>

              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-2">
                  <MapPin className="text-red-600" size={18} />
                  <label className="text-sm font-semibold text-gray-600">Loading Point</label>
                </div>
                <p className="text-lg font-medium text-gray-900">{selectedActivity.loadingPoint?.code || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.loadingPoint?.name || ''}</p>
              </div>

              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-2">
                  <MapPin className="text-indigo-600" size={18} />
                  <label className="text-sm font-semibold text-gray-600">Dumping Point</label>
                </div>
                <p className="text-lg font-medium text-gray-900">{selectedActivity.dumpingPoint?.code || '-'}</p>
                <p className="text-sm text-gray-600">{selectedActivity.dumpingPoint?.name || ''}</p>
              </div>
              ...
              {selectedActivity.roadSegment && (
                <div className="col-span-2 bg-white p-4 rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <label className="text-sm font-semibold text-gray-600">Road Segment</label>
                  </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="bg-white p-3 rounded-lg border border-green-100">
                  <label className="text-xs font-medium text-gray-600">Load Weight</label>
                  <p className="text-2xl font-bold text-green-600 mt-1">
                    {selectedActivity.loadWeight} <span className="text-sm">ton</span>
                  </p>
                </div>
                <div className="bg-white p-3 rounded-lg border border-green-100">
                  <label className="text-xs font-medium text-gray-600">Target Weight</label>
                  <p className="text-2xl font-bold text-gray-900 mt-1">
                    {selectedActivity.targetWeight} <span className="text-sm">ton</span>
                  </p>
                </div>
                <div className="bg-white p-3 rounded-lg border border-green-100">
                  <label className="text-xs font-medium text-gray-600">Load Efficiency</label>
                  <p className="text-2xl font-bold text-blue-600 mt-1">{selectedActivity.loadEfficiency ? selectedActivity.loadEfficiency.toFixed(1) : '-'}%</p>
                </div>
                <div className="bg-white p-3 rounded-lg border border-green-100">
                  <label className="text-xs font-medium text-gray-600">Distance</label>
                  <p className="text-2xl font-bold text-purple-600 mt-1">
                    {selectedActivity.distance} <span className="text-sm">km</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-4 rounded-lg border border-purple-200">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white p-3 rounded-lg border border-purple-100">
                  <label className="text-xs font-medium text-gray-600">Queue Duration</label>
                  <p className="text-xl font-bold text-gray-900 mt-1">
                    {selectedActivity.queueDuration || 0} <span className="text-sm">min</span>
                  </p>
                ...
                <div className="bg-white p-3 rounded-lg border border-purple-100">
                  <label className="text-xs font-medium text-gray-600">Loading Duration</label>
                  <p className="text-xl font-bold text-gray-900 mt-1">
                    {selectedActivity.loadingDuration || 0} <span className="text-sm">min</span>
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="bg-white p-3 rounded-lg border border-purple-100">
                  <label className="text-xs font-medium text-gray-600">Hauling Duration</label>
                  <p className="text-xl font-bold text-gray-900 mt-1">
                    {selectedActivity.haulingDuration || 0} <span className="text-sm">min</span>
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="bg-white p-3 rounded-lg border border-purple-100">
                  <label className="text-xs font-medium text-gray-600">Dumping Duration</label>
                  <p className="text-xl font-bold text-gray-900 mt-1">
                    {selectedActivity.dumpingDuration || 0} <span className="text-sm">min</span>
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="bg-white p-3 rounded-lg border border-purple-100">
                  <label className="text-xs font-medium text-gray-600">Return Duration</label>
                  <p className="text-xl font-bold text-gray-900 mt-1">
                    {selectedActivity.returnDuration || 0} <span className="text-sm">min</span>
                  </p>
                  {selectedActivity.returnTime && <p className="text-xs text-gray-500 mt-1">Returned at: {new Date(selectedActivity.returnTime).toLocaleTimeString()}</p>}
                </div>
                <div className="bg-purple-100 p-3 rounded-lg border border-purple-200">
                  <label className="text-xs font-medium text-purple-800">Total Cycle Time</label>
                  <p className="text-2xl font-bold text-purple-700 mt-1">
                    {selectedActivity.totalCycleTime || 0} <span className="text-sm">min</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-white p-3 rounded-lg border border-red-100">
                    <label className="text-xs font-medium text-gray-600">Delay Minutes</label>
                    <p className="text-xl font-bold text-red-600 mt-1">
                      {selectedActivity.delayMinutes || 0} <span className="text-sm">min</span>
                    </p>
                  </div>
                  {selectedActivity.delayReasonDetail && (
                    <div className="col-span-2 bg-white p-3 rounded-lg border border-red-100">
                      <label className="text-xs font-medium text-gray-600">Delay Reason</label>
                      <p className="text-sm text-gray-900 mt-1">{selectedActivity.delayReasonDetail}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {selectedActivity.fuelConsumed && (
              <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                <h4 className="text-sm font-semibold text-orange-700 mb-2 flex items-center space-x-2">
                  <Gauge className="text-orange-600" size={18} />
                  <span>Fuel Consumption</span>
                </h4>
                <p className="text-2xl font-bold text-orange-600">
                  {selectedActivity.fuelConsumed} <span className="text-sm">liters</span>
                </p>
              </div>
            )}
            ...
            {selectedActivity.weatherCondition && (
              <div className="bg-sky-50 p-4 rounded-lg border border-sky-200">
                <h4 className="text-sm font-semibold text-sky-700 mb-2">Weather Condition</h4>
                <p className="text-lg font-medium text-gray-900">{selectedActivity.weatherCondition}</p>
              </div>
            )}
            ...
            {selectedActivity.remarks && (
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-900">{selectedActivity.remarks}</p>
              </div>
            )}

            {(selectedActivity.predictedDelayRisk || selectedActivity.predictedDelayMinutes) && (
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                <h4 className="text-sm font-semibold text-yellow-700 mb-3 flex items-center space-x-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {selectedActivity.predictedDelayRisk && (
                    <div className="bg-white p-3 rounded-lg border border-yellow-100">
                      <label className="text-xs font-medium text-gray-600">Predicted Delay Risk</label>
                      <p className="text-lg font-medium text-gray-900 mt-1">{selectedActivity.predictedDelayRisk}</p>
                    </div>
                  )}
                  {selectedActivity.predictedDelayMinutes && (
                    <div className="bg-white p-3 rounded-lg border border-yellow-100">
                      <label className="text-xs font-medium text-gray-600">Predicted Delay</label>
                      <p className="text-lg font-medium text-gray-900 mt-1">
                        {selectedActivity.predictedDelayMinutes} <span className="text-sm">min</span>
                      </p>
                    </div>
                  )}
                </div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 text-xs text-gray-600">
              <div className="flex justify-between">
                <div>
                  <strong>Created:</strong> {selectedActivity.createdAt ? new Date(selectedActivity.createdAt).toLocaleString() : '-'}
                </div>
                <div>
                  <strong>Updated:</strong> {selectedActivity.updatedAt ? new Date(selectedActivity.updatedAt).toLocaleString() : '-'}
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Activity Number *</label>
                <input type="text" value={formData.activityNumber} onChange={(e) => setFormData({ ...formData, activityNumber: e.target.value })} className="input-field" required placeholder="HA-20251203-001" />
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Load Weight (ton) *</label>
                <input type="number" step="0.01" value={formData.loadWeight} onChange={(e) => setFormData({ ...formData, loadWeight: e.target.value })} className="input-field" required placeholder="28.5" min="0" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Target Weight (ton) *</label>
                <input type="number" step="0.01" value={formData.targetWeight} onChange={(e) => setFormData({ ...formData, targetWeight: e.target.value })} className="input-field" required placeholder="30.0" min="0" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Distance (km) *</label>
                <input type="number" step="0.01" value={formData.distance} onChange={(e) => setFormData({ ...formData, distance: e.target.value })} className="input-field" required placeholder="2.5" min="0" />
              </div>
              ...
              <div className="col-span-2">
                ...
                <textarea value={formData.remarks} onChange={(e) => setFormData({ ...formData, remarks: e.target.value })} className="input-field" rows="3" placeholder="Optional notes or remarks..." />
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <select value={formData.shift} onChange={(e) => setFormData({ ...formData, shift: e.target.value, operatorIds: [], operatorId: '' })} className="input-field" required>
                  <option value="SHIFT_1">Shift 1 (Pagi)</option>
                  <option value="SHIFT_2">Shift 2 (Siang)</option>
                  <option value="SHIFT_3">Shift 3 (Malam)</option>
                </select>
              ...
              <div className="col-span-2">
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  <Truck size={16} className="inline mr-2 text-blue-600" />
                  Select Trucks * <span className="text-xs text-gray-500">({formData.truckIds.length} selected)</span>
                </label>
                <div className="border border-gray-300 rounded-lg p-3 max-h-48 overflow-y-auto bg-white">
                  <div className="flex justify-between items-center mb-2 pb-2 border-b">
                    <button type="button" onClick={() => setFormData({ ...formData, truckIds: trucks.map((t) => t.id) })} className="text-xs text-blue-600 hover:text-blue-800">
                      Select All
                    </button>
                    <button type="button" onClick={() => setFormData({ ...formData, truckIds: [] })} className="text-xs text-gray-600 hover:text-gray-800">
                      Clear All
                    </button>
                  </div>
                  {trucks.map((truck) => (
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  <Construction size={16} className="inline mr-2 text-orange-600" />
                ...
                <div className="border border-gray-300 rounded-lg p-3 max-h-40 overflow-y-auto bg-white">
                  <div className="flex justify-between items-center mb-2 pb-2 border-b">
                    <button type="button" onClick={() => setFormData({ ...formData, excavatorIds: excavators.map((e) => e.id) })} className="text-xs text-orange-600 hover:text-orange-800">
                      Select All
                    </button>
                    <button type="button" onClick={() => setFormData({ ...formData, excavatorIds: [] })} className="text-xs text-gray-600 hover:text-gray-800">
                      Clear All
                    </button>
                  </div>
                  {excavators.map((exc) => (
              ...
              <div>
                ...
                <div className="border border-gray-300 rounded-lg p-3 max-h-40 overflow-y-auto bg-white">
                  <div className="flex justify-between items-center mb-2 pb-2 border-b">
                    <button type="button" onClick={() => setFormData({ ...formData, operatorIds: filteredOperators.map((o) => o.id) })} className="text-xs text-green-600 hover:text-green-800">
                      Select All
                    </button>
                    <button type="button" onClick={() => setFormData({ ...formData, operatorIds: [] })} className="text-xs text-gray-600 hover:text-gray-800">
                      Clear All
                    </button>
                  </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Load Weight (ton)</label>
                <input type="number" step="0.01" value={formData.loadWeight} onChange={(e) => setFormData({ ...formData, loadWeight: e.target.value })} className="input-field" placeholder="28.5" min="0" />
              </div>
              ...
              <div className="col-span-2">
                <label className="block text-sm font-semibold text-gray-700 mb-2">Remarks (Applied to all activities)</label>
                <textarea value={formData.remarks} onChange={(e) => setFormData({ ...formData, remarks: e.target.value })} className="input-field" rows="2" placeholder="Optional notes or remarks..." />
              </div>
            </div>
                  ...
                  {formData.truckIds.map((truckId, idx) => {
                    ...
                    return (
                      <div key={idx} className="py-1 border-b border-green-200 last:border-0">
                        <span className="font-medium">{truck?.code}</span> → Excavator: {exc?.code || 'N/A'}, Operator: {op?.employeeNumber || 'N/A'}
                      </div>
                    );
                  })}
                </div>
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg font-medium transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center space-x-2"
              >
                <Plus size={18} />
