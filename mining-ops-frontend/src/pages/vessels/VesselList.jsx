              ...
              <div className="flex gap-2">
                ...
                {activeFiltersCount > 0 && (
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 py-2 rounded-lg border border-slate-700/50 bg-slate-800/50 text-slate-300 hover:bg-slate-700/50 font-medium transition-colors flex items-center justify-center gap-2"
                  >
                    <X size={18} />
                    <span>Clear</span>
                  </button>
